...
#include "../Menus/PlayerSelectMenu.h"
#include "../Menus/NewPlayerMenu.h"
#include "../Menus/LevelSelectMenu.h"
#include "../Menus/HighscoresMenu.h"
#include "../Menus/PauseMenu.h"
#include "../Menus/LevelCompleteMenu.h"
...
void ScreenManager::loadScreens()
{
	...
	addScreen(new PlayerSelectMenu());
	addScreen(new NewPlayerMenu());
	addScreen(new SettingsMenu());
	addScreen(new HighscoresMenu());
	addScreen(new GameOverMenu());
	addScreen(new LevelCompleteMenu());
	addScreen(new Game());
